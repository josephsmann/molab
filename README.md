...
| [`intransitivity.py`](notebooks/intransitivity.py) — what a scalar rating (Elo/Bradley–Terry) can't express: style circles, the Hodge split into ratings plus circulation, how many skills a circle needs, and a runnable diagnostics checklist for real match data | [![Open in molab](https://marimo.io/molab-shield.svg)](https://molab.marimo.io/github/josephsmann/molab/blob/main/notebooks/intransitivity.py) [(wasm preview)](https://molab.marimo.io/github/josephsmann/molab/blob/main/notebooks/intransitivity.py/wasm) |
| [`euler.py`](notebooks/euler.py) — Euler's rotation theorem as a statement about kernels: every 3×3 skew matrix is a cross product, its null space is the axis, and why 4D rotations have no axis at all | [![Open in molab](https://marimo.io/molab-shield.svg)](https://molab.marimo.io/github/josephsmann/molab/blob/main/notebooks/euler.py) [(wasm preview)](https://molab.marimo.io/github/josephsmann/molab/blob/main/notebooks/euler.py/wasm) |
